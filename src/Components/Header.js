...
const Header = () => {
  ...
  return (
    <div className=' w-full flex justify-between  align-bottom bg-gradient-to-b from-black absolute z-20 px-5 '>
      ...
      {isUserSignIn ? <button onClick={handleGptSearchClick} className=' py-0 text-small px-2 mx-2 my-3 md:py-2 md:px-4 md:mx-4 md:my-2 bg-purple-700  text-white rounded-lg '>
